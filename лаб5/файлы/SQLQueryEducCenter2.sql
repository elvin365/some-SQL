...
-- CREATE INDEX ItogOcenk on Ocenka (ItogovayaOcenka ) --новый простой индекс
-- CREATE INDEX Zhurnal on Ocenka (ZHurnal_OcenokKursNazvanie ) --новый простой индекс
--CREATE NONCLUSTERED INDEX ocenkaPassportByKurs
--ON [dbo].[Ocenka] ([ZHurnal_OcenokKursNazvanie])
--INCLUDE ([ItogovayaOcenka],[ObuchayushchijsyaNumerPassporta]) -- INCLUDE - leaf level

--CREATE INDEX Ocenk_Zh on Ocenka (ZHurnal_OcenokKursNazvanie) 
